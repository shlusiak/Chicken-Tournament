...
const int FLAG_SIZE=6;
const int NUM_FLAG_VERTICES=((FLAG_SIZE+1)*(FLAG_SIZE+1));
const int NUM_FLAG_INDICES=(FLAG_SIZE*FLAG_SIZE*6);
const int NUM_POLE_VERTICES=8*2;
