...
VOID D3DUtil_InitSurfaceDesc( DDSURFACEDESC2& ddsd, DWORD dwFlags=0,
                              DWORD dwCaps=0 );
VOID D3DUtil_InitMaterial( D3DMATERIAL7& mdMtrlData, const FLOAT r=0.0f, const FLOAT g=0.0f,
                           const FLOAT b=0.0f );
VOID D3DUtil_InitLight( D3DLIGHT7& ldLightData, const D3DLIGHTTYPE ltType,
...
inline VOID D3DUtil_SetTranslateMatrix( D3DMATRIX& m, const FLOAT tx, const FLOAT ty,
                                        const FLOAT tz )
{ D3DUtil_SetIdentityMatrix( m ); m._41 = tx; m._42 = ty; m._43 = tz; }

inline VOID D3DUtil_SetTranslateMatrix( D3DMATRIX& m, const D3DVECTOR& v )
{ D3DUtil_SetTranslateMatrix( m, v.x, v.y, v.z ); }

inline VOID D3DUtil_SetScaleMatrix( D3DMATRIX& m, const FLOAT sx, const FLOAT sy,
                                    const FLOAT sz )
